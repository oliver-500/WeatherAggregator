...
impl ChannelPool {
    ...
    pub async fn monitor_connection(&self, retry_tx: Sender<BrokerTask>, is_broker_up: Arc<AtomicBool>) {
        loop {
    ...
    pub async fn configure_channel_pool(
        ...
        tokio::spawn(async move {
            monitor_clone.monitor_connection(retry_tx_pointer, is_broker_up_pointer.clone()).await;
        });
    }
