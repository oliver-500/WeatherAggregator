...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      // Service 1: Weather
      '/api/weather': {
        target: 'http://weather-aggregator-aggregator-service-app:9000',
        changeOrigin: true,
      ...
      // Service 2: Users
      '/api/auth': {
        target: 'http://weather-aggregator-user-identity-service-app:9010',
        changeOrigin: true,
        secure: false,
      ...
      // Service 3: Settings
      '/api/user': {
        target: 'http://weather-aggregator-user-preferences-service-app:9011',
        changeOrigin: true,
        secure: false,
