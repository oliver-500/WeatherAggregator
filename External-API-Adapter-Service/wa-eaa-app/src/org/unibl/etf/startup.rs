...
use crate::org::unibl::etf::controllers::weather_api_controller;
use crate::org::unibl::etf::controllers::openweather_api_controller;
...
pub fn run(
    ...
    let geocoding_service = web::Data::new(GeocodingService::default());
    ...
    let server = HttpServer::new(move || {
        App::new()
            ...
            .service(
                web::scope("/api/v1/providers")
                    .configure(weather_api_controller::routes)
                    .configure(openweather_api_controller::routes)
            )
