...
pub enum AdapterError {
    ...
    ExternalApiError(u16, String),
    AmbiguousLocation(String, Vec<Candidate>),
    ServerError,
    ValidationError,
...
impl AdapterError {
    ...
    pub fn as_numeric(&self) -> u16 {
        match self {
            ...
            AdapterError::ServerError => 500,
            AdapterError::ValidationError => 400,
            AdapterError::AmbiguousLocation(_, _) => 400,
